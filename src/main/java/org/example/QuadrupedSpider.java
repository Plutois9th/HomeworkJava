...
public class QuadrupedSpider {
    public int leg; //позиция лапки робота в градусах, может быть любой изначальной
    public int hip; //позиция "бедра" робота в градусах, может быть любой изначальной
